...
For this problem, I decided to implement a function to calculate the row reduced matrix and the rank to practice my coding skills. I implemented a generic function to calculate any $`m\times n`$. I have three cases for ranking a matrix as following:
+ m > n
+ m < n
+ Finally m = n
